...
# that we can build fat binaries using the normal GCC driver for most of the work.
#
...
# however it might also be necessary to partition arch-specific flags in some cases.
#
